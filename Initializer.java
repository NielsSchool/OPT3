...
public class Initializer {
    public static void InitialiseerContent() {
        Wasprogramma wasprogramma1 = new Wasprogramma(120, Arrays.asList(false, false, true), "Klein | 80 graden C | zonder droger", "Deze was is 80 graden en wast minder dan 5 kilo kleding waarbij kleding zelf gedroogt moet worden.");
        Wasprogramma wasprogramma2 = new Wasprogramma(100, Arrays.asList(false, false, true), "Klein | 60 graden C | zonder droger", "Deze was is 60 graden en wast minder dan 5 kilo kleding waarbij kleding zelf gedroogt moet worden.");
        Wasprogramma wasprogramma3 = new Wasprogramma(80, Arrays.asList(false, true, false), "Groot | 80 graden C | zonder droger", "Deze was is 80 graden en wast minder dan 20 kilo kleding waarbij kleding zelf gedroogt moet worden.");
        Wasprogramma wasprogramma4 = new Wasprogramma(60, Arrays.asList(false, true, false), "Groot | 60 graden C | zonder droger", "Deze was is 60 graden en wast minder dan 20 kilo kleding waarbij kleding zelf gedroogt moet worden.");
        Wasprogramma wasprogramma5 = new Wasprogramma(150, Arrays.asList(true, false, false), "| 80 graden C | met droger", "Deze was is 80 graden en wast minder dan 8 kilo kleding waarbij kleding gedroogt wordt.");
        Wasprogramma wasprogramma6 = new Wasprogramma(100, Arrays.asList(true, false, false), "| 60 graden C | met droger", "Deze was is 60 graden en wast minder dan 8 kilo kleding waarbij kleding gedroogt wordt.");
